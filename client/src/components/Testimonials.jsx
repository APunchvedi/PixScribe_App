...
const Testimonials = () => {
  return (
      ...
      >
          ...
          <p className="text-gray-500 mb-12">What are our users are saying</p>
          
          <div className='flex flex-wrap gap-6'>
              {testimonialsData.map((testimonials, index) => (
                  <div key={index}>
                      <div className='bg-white/20 p-12 rounded-lg shadow-md w-80 margin-auto cursor-pointer hover:scale-[1.02] transition-all'>
                          ...
                          <div className='flex mb-4'>
                              ...
                              return <img key={index} src={assets.rating_star} alt="" />
                                  })
                              }
